const products = [
  {
    ...
    detail:` Quần jeans nữ form ôm, dễ phối đồ, phù hợp đi học đi chơi.<br>
    Sản phẩm có form ôm nhẹ giúp tôn dáng, tạo cảm giác thon gọn nhưng không gây khó chịu khi vận động.
    `
